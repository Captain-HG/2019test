package com.lzc.sendmessage.utils;
...
public class AliyunMessageUtil {
    ...
    /** 此处需要替换成开发者自己的AK(在阿里云访问控制台寻找)*/
     private static final String accessKeyId = "LTAIuG7D7PeyByGR";
    private static final String accessKeySecret = "ZjUADeC3tGb0OurWc5wy85t2UD6WDE";
